...
import 'package:beyond_flutter/widgets/stars/star.dart';
import 'package:flame/components.dart';
import 'package:flutter/material.dart';

const initialSpeed = 400.0;
const finalSpeed = 200.0;
      ...
      await add(
        ParticleSystemComponent(
          particle: Star(
            ...
            initialPosition:
                Vector2(cameraSize.x / 2, cameraSize.y / 2) +
                Vector2(
        ...
        add(
          ParticleSystemComponent(
            particle: Star(
              ...
              travelSpeed: initialSpeed + (finalSpeed - initialSpeed) * 1,
              distanceFromCamera: 0,
              starSize: starSizeDistribution(),
              cameraSize: cameraSize,
              globalParams: GlobalParams(
